                ...
                <div class="col margin-bottom-menu">
                    <f-card>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fSelfStaked' in dTotals">{{ dTotals.fSelfStaked }} XN <span v-if="cSelfStaked">({{ cSelfStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalDelegated' in dTotals">{{ dTotals.fTotalDelegated }} XN <span v-if="cDelegated">({{ cDelegated }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="'fTotalStaked' in dTotals">{{ dTotals.fTotalStaked }} XN <span v-if="cStaked">({{ cStaked }}%)</span></div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="cDailyRewards">{{ formatNumberByLocale(numToFixed(cDailyRewards, 0)) }} XN</div>
                            </div>
                        </div>
                        ...
                        <div class="row no-collapse">
                            ...
                            <div class="col">
                                <div v-show="dTotalSupply">{{ formatNumberByLocale(numToFixed(dTotalSupply, 0)) }} XN</div>
                            </div>
                        </div>
<!--
                        <div class="row no-collapse">
